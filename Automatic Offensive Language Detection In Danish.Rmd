...
testing$rf<-predictions_RF$.pred_class
testing$label<-as.numeric(testing$label)-1
testing$rf<-as.numeric(testing$rf)-1
testing$rf<-as.character(testing$rf)
testing$label<-as.character(testing$label)

testing$rf<-as.factor(testing$rf)
testing$label<-as.factor(testing$label)


#F1-Score
F1_Score_macro(y_true= testing$label, y_pred = testing$rf)

#write.csv(testing, "RF_preds.tsv", sep= "\t")
